...
const UserDetails = ({ user }) => {
    ...
    return (
        <dl>
            ...
            <DetailRow label="Fecha de Creación" value={new Date(user.createdAt).toLocaleString()} />
            <DetailRow label="Última Actualización" value={new Date(user.updatedAt).toLocaleString()} />
        </dl>
    );
};
